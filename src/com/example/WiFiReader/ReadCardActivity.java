...
public class ReadCardActivity  extends Activity  {
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    eTBlockNum = (EditText)findViewById(R.id.eTReadBlockNum);
	    etPassword = (EditText)findViewById(R.id.eTReadBlockPassword);
	    
	    
	    btnReadCard = (Button)findViewById(R.id.btnRead);
